    ...
    handleUpload() {
        ...
        if (file.type) {
            ...
            if (file.type === 'video/mp4') {
                fetch('http://169.62.12.179:5000/video', {
                    method: 'POST',
            ...
            // Process image
                ...
                getBase64(file)
                .then(fileData => {
                    fetch('http://169.62.12.179:5000/image', {
                        method: 'POST',
    ...
    render() {
        ...
        if (this.state.modelOutput) {
            if (this.state.fileType === "video/mp4") {
                ...
                bodyContent = (
                    <img src={this.state.modelOutput} class='outputElement'></img>
                )
            }
        } else if (this.state.fileLoading) {
            bodyContent = <h1>Loading...</h1>
        } else {
            bodyContent = <h1>Select a file or take a screenshot...</h1>
        }
